...
module.exports = {
	0: { // Warrior
		...
		34: { // Binding Sword
			0: { 
				length: 1902,
				noInterrupt: [1, 2, 3, 4, 5, 10, 11, 12, 13, 16, 17, 18, 19, 20, 21, 22, 23, 27, 28, 29, 32, 33, 34, 35, 36, 37, 39, 40, 41, 42]
			}
		},
		35: { // Infuriate
			0: { 
	...
	1: { // Lancer
		...
		13: { // Spring Attack
			0: {
				length: 2800,
				distance: 85,
				noInterrupt: ['1-0', '1-1', 2, 3, 4, 9, 11, 12, 13, 15, '18-0', 21, 23, 24, 25, 26, 27, 28, 29],
				chains: {
					1: 30,
					5: 30,
					8: 30,
